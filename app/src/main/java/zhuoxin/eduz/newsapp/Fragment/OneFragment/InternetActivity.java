 ...
 */
public class InternetActivity extends Fragment{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout= (SwipeRefreshLayout) view.findViewById(R.id.swip_intennet);
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                swipeRefreshLayout.setRefreshing(true);
                Snackbar.make(recyclerView,"刷新完成",Snackbar.LENGTH_SHORT).show();
    ...
    private void getStringResult() {
        String url = "http://118.244.212.82:9092/newsClient/news_list?ver=1&subid=1&dir=2&nid=1&stamp=20140322&cnt=20";
